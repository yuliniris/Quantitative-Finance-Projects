...
## Project Report
Full project report *Variance Swap Replication*: [Project Report PDF](https://github.com/yuliniris/Quantitative-Finance-Projects/blob/main/Variance_Swap_Replication/Report/variance_swap _replication.pdf)
